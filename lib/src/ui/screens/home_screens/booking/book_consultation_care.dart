...
class BookConsultationCare extends StatefulWidget {
  static const routeName = 'book-consultation-care';

  final ListDoctor doctor;
  final String? typeofBook;
  const BookConsultationCare({Key? key, required this.doctor, this.typeofBook})
      : super(key: key);

  @override
  State<BookConsultationCare> createState() => _BookConsultationCareState();
}

class _BookConsultationCareState extends State<BookConsultationCare> {
              ...
              (controller.buttonLoad == true)
                  ...
                  : CustomButton(
                      ...
                      onTap: () => controller.createBooking(
                          context,
                          widget.doctor.id!,
                          (widget.typeofBook == 'Wellness Checkup')
                              ? 'Wellness Checkup'
...
//   @override
//   Widget build(
//       BuildContext context, DateTime date, void Function(DateTime datetime)? onTap) {
//     return DefaultDayTile(
//       date: date,
//       onTap: onTap,
//       selectedDayColor: tabColor,
